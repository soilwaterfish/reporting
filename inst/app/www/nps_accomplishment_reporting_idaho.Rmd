...
The latest iteration of the Memorandum of Understanding (MOU) between the U.S. Forest Service (USFS) in Idaho and the Idaho Department of Environmental Quality (ID DEQ) was signed in early 2020 as a five-year update to the longstanding MOU. Among those notable changes to the MOU was addition of Section IV (J), which states:  
...
For `r params$fiscal_year`, geospatial data has again been shared with IDEQ representing locations where selected watershed restoration activities have occurred on USFS-managed lands.  
